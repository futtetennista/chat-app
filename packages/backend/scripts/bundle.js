...
var nonProdBuildOptions = __assign(__assign({}, defaultBuildOptions), {
  minify: false,
  sourcemap: false,
  outfile: "dist/non-prod/index.js",
});
var prodBuildOptions = __assign(__assign({}, defaultBuildOptions), {
  minify: false,
  sourcemap: true,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              esbuild.build(buildOptions).catch(function (e) {
